            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="hero-cap text-center">
                        ...
                        <h2>{{ $sites->first()->district->name ?? 'No District' }}</h2>
                ...
                <div class="single-place mb-30">
                    ...
                    <div class="place-cap">
                        ...
                        <div class="place-cap-bottom">
                            <p class="m-0">No sites match your search query.</p>
                        </div>
                ...
                <div class="single-place mb-30">
                    ...
                    <div class="place-cap">
                        ...
                        <div class="place-cap-top">
                                ...
                                <span>
                                    @if ($site->condition == 1)
                                    <span class="text-green-600">Well Preserved</span>
                                    @elseif ($site->condition == 2)
                                    <span class="text-orange-600">Vulnerable</span>
                                    @elseif ($site->condition == 3)
